...
%     ebpv(2,3)     Earth barycentric pos/vel (au, au/day)地球重心 pos/vel
%     ehp(3)        Earth heliocentric position (au)地球日心位置
%
%  Returned:
%     astrom         star-independent astrometry parameters:与恒星无关的天体测量参数
