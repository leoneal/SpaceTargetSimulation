...
%
%  Given:
%     ra1        right ascension (radians), before 赤经
%     dec1       declination (radians), before 赤纬
%     pmr1       RA proper motion (radians/year), before 自行赤经
%     pmd1       Dec proper motion (radians/year), before 自行赤纬
%     px1        parallax (arcseconds), before 视差
%     rv1        radial velocity (km/s, +ve = receding), before 视向速度
